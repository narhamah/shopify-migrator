...
def check_theme_template(client):
    ...
    try:
        ...
        print("  WARNING: No metaobject/ingredient template found in theme!")
        print(f"  The theme needs a template at '{template_key}' to render ingredient pages.")
        print("  You can create this in the Shopify Theme Editor:")
        print("    1. Go to Online Store → Themes → Customize")
        print("    2. In the template dropdown, create a new template for 'metaobject/ingredient'")
        print("    3. Design the ingredient page layout with sections")
