...
# =====================================================================
_TOV_DIR = os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", ".."))


def _load_tov(filename: str) -> str:
...
class Translator:
    ...
    def _translate_metafield_value(self, mf: dict[str, str], source_lang: str, target_lang: str) -> str:
    ...
    def translate_rich_text(self, rich_text_json: str, source_lang: str, target_lang: str) -> str:
    ...
    def translate_product(self, product: dict[str, Any], source_lang: str, target_lang: str) -> dict[str, Any]:
    ...
    def translate_page(self, page: dict[str, Any], source_lang: str, target_lang: str) -> dict[str, Any]:
    ...
    def translate_collection(self, collection: dict[str, Any], source_lang: str, target_lang: str) -> dict[str, Any]:
    ...
    def translate_blog(self, blog: dict[str, Any], source_lang: str, target_lang: str) -> dict[str, Any]:
    ...
    def translate_article(self, article: dict[str, Any], source_lang: str, target_lang: str) -> dict[str, Any]:
    ...
    def translate_metaobject(self, metaobject: dict[str, Any], source_lang: str, target_lang: str) -> dict[str, Any]:
