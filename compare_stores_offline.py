...
def main():
    ...
    print(f"  Expected URLs: /pages/ingredient/{{handle}}")
    print(f"  Sample URLs:")
    ...
    print(f"\n  NEXT STEPS:")
    print(f"    1. Run 'python compare_stores.py' locally to check live store rendering")
    print(f"    2. Run 'python audit_store.py' locally to verify Saudi store state")
    print(f"    3. Migrate the {len(not_migrated)} missing products")
    print(f"    4. Fix ingredient card links (theme section edit)")
    print(f"    5. Configure homepage product section with collection")
    print(f"    6. Install app integrations (Klaviyo, Subscriptions)")
